...
FIrst action is to download the zip file from my Git repository, unzip it and load the CSV in **myData** variable.

```{r}
temp <- tempfile()
download.file("https://github.com/juancho182/RepData_PeerAssessment1/blob/master/activity.zip",temp, mode="wb")
